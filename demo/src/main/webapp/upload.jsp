            ...
            <form class="needs-validation" novalidate method="post" action="upload" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="document" id="chooseFile">Choose file</label>
                        <div class="invalid-feedback">
...
<script>
    let inputFile = document.getElementById("document")
    inputFile.onchange = ()=>{
        console.log(inputFile)
        document.getElementById("chooseFile").innerText=inputFile.files[0].name;
    }
</script>
</body>
</html>